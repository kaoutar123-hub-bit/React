        ...
        <>
            <header className={styles.topbar}>
                ...
                <div className={`${styles.dataLoggedContainer} dataLoggedContainer`}>
                        ...
                        <Link className={styles.linkHeaderNickImg} to="/profile"><img src={user.foto_perfil ? `${import.meta.env.VITE_API_URL}/api/storage/${user.foto_perfil}`: userPic} alt="FotoPerfil" className={styles.headerProfileImg} />
